...
function page(e)
{
    ...
    for(let k=start;k<end;k++)
    {
       if(k==arr.length)
       {
        ...
        // let row =`
        // <div onclick=alert() class="col-md-3 product my-5">
        //     <div class="card" style="width: 18rem;">
        //             <img  src="images/products/${arr[k].product_pic}" class="card-img-top" alt="...">
        //             <div class="card-body">
        //                 <h4 class="card-title">${arr[k].name}</h4>
        //                 <p class="card-text">${arr[k].price}$</p>
        //             </div>
        //     </div>
        // </div>`;
...
function displaySearchedData(data)
{
    ...
    {
        // let row =`
        // <div class="col-md-3 search-product my-5">
        //     <div class="card" style="width: 18rem;">
        //             <img  src="images/products/${data[k].product_pic}" class="card-img-top" alt="...">
        //             <div class="card-body">
        //                 <h4 class="card-title">${data[k].name}</h4>
        //                 <p class="card-text">${data[k].price}$</p>
        //             </div>
        //     </div>
        // </div>`;
        // document.getElementById("search").innerHTML+=row;
